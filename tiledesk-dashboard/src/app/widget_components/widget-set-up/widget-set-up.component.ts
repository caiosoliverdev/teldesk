    ...
    this.projectService.getProjectById(this.id_project).subscribe((project: any) => {
      ...
      if (project.widget) {
        ...
        if (project.widget.poweredBy) {
          ...
          // this.footerBrand = '<a tabindex="-1" target="_blank" href="http://www.tiledesk.com/?utm_source=widget"><img src="https://panel.tiledesk.com/v3/dashboard/assets/img/logos/tiledesk-solo_logo_new_gray.svg"/><span>Powered by SyncYou</span></a>';
