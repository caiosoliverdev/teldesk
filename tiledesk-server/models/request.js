...
// The user who is asking for support through a ticket is the requester. For most businesses that use SyncYou Support, the requester is a customer, but requesters can also be agents in your SyncYou Support instance.  requester: {
  requester: {
...
// Note nobody_admin indicates the conversation is assigned to Nobody.
  ...
  */
  ...
  channel: { //inbound. Channel used by the requester(visitor or user) to communicate with SyncYou. If widget-> channel is chat21, if Whatsapp-> channel is Whatsapp, etc..
    type: Channel.schema,
    default: function() {
  ...
  channelOutbound: { //outbound. Channel used to send the messages generated by the requester and internally (internal bot or info messages)  to the agents. This is chat21. Fare diagramma come foglio
    // CANCELLA: Channel used by the messages generated by the SyncYou(internal bots or info messages)to communicate to the requester. This is chat21
    type: Channel.schema,
    default: function() {
      return new Channel({name: 'chat21'});
    }
